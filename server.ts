...
import { House, HouseRequest, HouseResponse, HousesBySizeRequest, HousesBySizeResponse, HousesRequest, HousesResponse } from "./house_pb";
...
class houseService implements IhouseServiceServer {
  ...
  public getHouses(
    ...
    response.setHouseList(housesObj);
    callback(null, response);
  }
}
